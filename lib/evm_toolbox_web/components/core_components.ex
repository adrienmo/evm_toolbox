defmodule EvmToolboxWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(EvmToolboxWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(EvmToolboxWeb.Gettext, "errors", msg, opts)
    end
  end
